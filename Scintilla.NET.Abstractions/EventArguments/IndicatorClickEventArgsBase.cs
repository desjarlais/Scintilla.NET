...
/// </summary>
public abstract class IndicatorClickEventArgsBase<TMarkers, TStyles, TIndicators, TLines, TMargins, TSelections, TEventArgs, TMarker, TStyle, TIndicator, TLine, TMargin, TSelection, TBitmap, TColor, TKeys> 
    ...
    where TKeys: Enum
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="IndicatorClickEventArgsBase{TMarkers, TStyles, TIndicators, TLines, TMargins, TSelections, TEventArgs, TMarker, TStyle, TIndicator, TLine, TMargin, TSelection, TBitmap, TColor, TKeys}" /> class.
    /// </summary>
