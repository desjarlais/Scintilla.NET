...
/// </summary>
public abstract class MarkerCollectionBase<TMarkers, TStyles, TIndicators, TLines, TMargins, TSelections, TEventArgs, TMarker> : IEnumerable<TMarker>
    ...
    where TEventArgs : EventArgs
{
    ...
    protected MarkerCollectionBase(IScintillaApi<TMarkers, TStyles, TIndicators, TLines, TMargins, TSelections, TEventArgs> scintilla)
    {
