...
public class Marker : MarkerBase<MarkerCollection, StyleCollection, IndicatorCollection, LineCollection, MarginCollection, SelectionCollection, SCNotificationEventArgs, Marker, Style, Indicator, Line, Margin, Selection, Bitmap, Color>
{
    ...
    /// <remarks>Calling this method will also update the <see cref="MarkerBase{TBitmap,TColor,TMarkers,TStyles,TIndicators,TLines,TMargins,TSelections,TEventArgs}.Symbol" /> property to <see cref="MarkerSymbol.RgbaImage" />.</remarks>
    ...
    /// </remarks>
    /// <seealso cref="MarkerBase{TBitmap,TColor,TMarkers,TStyles,TIndicators,TLines,TMargins,TSelections,TEventArgs}.SetAlpha" />
