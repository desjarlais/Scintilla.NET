...
public class Selection
{
    ...
    public int Anchor
    {
        get
        {
            int pos = this.scintilla.DirectMessage(SciApi.SCI_GETSELECTIONNANCHOR, new IntPtr(Index)).ToInt32();
            if (pos <= 0)
                return pos;
        ...
        set
        {
            ...
            this.scintilla.DirectMessage(SciApi.SCI_SETSELECTIONNANCHOR, new IntPtr(Index), new IntPtr(value));
        }
    }
    ...
    public int AnchorVirtualSpace
    {
        get
        {
            return this.scintilla.DirectMessage(SciApi.SCI_GETSELECTIONNANCHORVIRTUALSPACE, new IntPtr(Index)).ToInt32();
        }
        set
        {
            value = Helpers.ClampMin(value, 0);
            this.scintilla.DirectMessage(SciApi.SCI_SETSELECTIONNANCHORVIRTUALSPACE, new IntPtr(Index), new IntPtr(value));
        }
    }
    ...
    public int Caret
    {
        get
        {
            int pos = this.scintilla.DirectMessage(SciApi.SCI_GETSELECTIONNCARET, new IntPtr(Index)).ToInt32();
            if (pos <= 0)
                return pos;
        ...
        set
        {
            value = Helpers.Clamp(value, 0, this.scintilla.TextLength);
            value = this.scintilla.Lines.CharToBytePosition(value).BytePosition;
            this.scintilla.DirectMessage(SciApi.SCI_SETSELECTIONNCARET, new IntPtr(Index), new IntPtr(value));
        }
    }
    ...
    public int CaretVirtualSpace
    {
        get
        {
            return this.scintilla.DirectMessage(SciApi.SCI_GETSELECTIONNCARETVIRTUALSPACE, new IntPtr(Index)).ToInt32();
        }
        set
        {
            value = Helpers.ClampMin(value, 0);
            this.scintilla.DirectMessage(SciApi.SCI_SETSELECTIONNCARETVIRTUALSPACE, new IntPtr(Index), new IntPtr(value));
        }
    }
    ...
    public int End
    {
        get
        {
            int pos = this.scintilla.DirectMessage(SciApi.SCI_GETSELECTIONNEND, new IntPtr(Index)).ToInt32();
            if (pos <= 0)
                return pos;
        ...
        set
        {
            value = Helpers.Clamp(value, 0, this.scintilla.TextLength);
            value = this.scintilla.Lines.CharToBytePosition(value).BytePosition;
            this.scintilla.DirectMessage(SciApi.SCI_SETSELECTIONNEND, new IntPtr(Index), new IntPtr(value));
        }
    }
    ...
    public int Start
    {
        get
        {
            int pos = this.scintilla.DirectMessage(SciApi.SCI_GETSELECTIONNSTART, new IntPtr(Index)).ToInt32();
            if (pos <= 0)
                return pos;
        ...
        set
        {
            value = Helpers.Clamp(value, 0, this.scintilla.TextLength);
            value = this.scintilla.Lines.CharToBytePosition(value).BytePosition;
            this.scintilla.DirectMessage(SciApi.SCI_SETSELECTIONNSTART, new IntPtr(Index), new IntPtr(value));
        }
    }
